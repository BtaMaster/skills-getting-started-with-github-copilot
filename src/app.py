...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice drills, teamwork, and compete in interschool soccer matches",
    ...
    "Math Olympiad": {
        "description": "Prepare for math competitions with problem solving and logic exercises",
